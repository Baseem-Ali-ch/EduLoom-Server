...
import { IEmailService, IUser } from 'interfaces/IUser';
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; border-radius: 8px;">
          ...
          <p style="text-align: center;">
            <a href="http://localhost:4200/instructor/register" 
          ...
          <p style="background-color: #f4f4f4; padding: 10px; border-radius: 5px;">
            <a href="http://localhost:4200/instructor/register" style="color: #4CAF50;">http://localhost:4200/instructor/register</a>
          </p>
